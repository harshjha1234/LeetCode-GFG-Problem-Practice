...
&nbsp;    4    10
&nbsp;   /
&nbsp;  3<br><span style="font-size: 18px;">key = 8 <strong>Output: <br></strong>4 9<strong> Explanation: <br></strong>In the given BST the inorder predecessor of 8 is 4 and inorder successor of 8 is 9.</span></pre>
...
&nbsp;    3    6
&nbsp;     \
&nbsp;      4<br><span style="font-size: 18px;">key = 11 <strong>Output: <br></strong>10 -1<strong> Explanation: <br></strong>In given BST, the inorder predecessor of 11 is 10 whereas it does not have any inorder successor.</span></pre>
